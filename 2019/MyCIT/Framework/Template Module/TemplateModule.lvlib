...
<Library LVVersion="19008000">
	...
	<Item Name="Private" Type="Folder">
		...
		<Item Name="Gui" Type="Folder">
			<Item Name="Gui.TopBar.ctl" Type="VI" URL="../Gui/Gui.TopBar.ctl"/>
			<Item Name="Gui.TopBar.Setting.vi" Type="VI" URL="../Gui/Gui.TopBar.Setting.vi"/>
			<Item Name="Gui.TopBar.Visibility.ctl" Type="VI" URL="../Gui/Gui.TopBar.Visibility.ctl"/>
			<Item Name="Gui.Translate.Choose.State.vi" Type="VI" URL="../Gui/Gui.Translate.Choose.State.vi"/>
			<Item Name="Gui.Translate.Choose.vi" Type="VI" URL="../Gui/Gui.Translate.Choose.vi"/>
		</Item>
