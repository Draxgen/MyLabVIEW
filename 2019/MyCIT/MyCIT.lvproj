...
<Project Type="Project" LVVersion="19008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Framework" Type="Folder">
			<Item Name="TemplateModule.lvlib" Type="Library" URL="../Framework/Template Module/TemplateModule.lvlib"/>
			<Item Name="Tools.lvlib" Type="Library" URL="../Framework/Tools/Tools.lvlib"/>
		</Item>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="ConfigurationWIzard.Config.ctl" Type="VI" URL="../Framework/Modules/Sequences_Management/SubVIs/ConfigurationWizard/controls/ConfigurationWIzard.Config.ctl"/>
			...
			<Item Name="Sequences_Management.Gui.Product.ctl" Type="VI" URL="../Framework/Modules/Sequences_Management/Gui/Sequences_Management.Gui.Product.ctl"/>
			<Item Name="shell32.dll" Type="Document" URL="shell32.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="Test_Panel.HeaderData.ctl" Type="VI" URL="../Framework/Modules/Test_Panel/subVI/Test_Panel.HeaderData.ctl"/>
			<Item Name="Test_Panel.UutTable.DisplayMode.ctl" Type="VI" URL="../Framework/Modules/Test_Panel/subVI/Test_Panel.UutTable/Test_Panel.UutTable.DisplayMode.ctl"/>
			<Item Name="TMOS.Config.Action.ctl" Type="VI" URL="../Framework/Tools/TMOS config/TMOS.Config.Action.ctl"/>
			<Item Name="TMOS.Config.vi" Type="VI" URL="../Framework/Tools/TMOS config/TMOS.Config.vi"/>
			<Item Name="TMOS.Path.Get.vi" Type="VI" URL="../Framework/Tools/TMOS/Path/TMOS.Path.Get.vi"/>
			<Item Name="TMOS.Path.Type.ctl" Type="VI" URL="../Framework/Tools/TMOS/Path/TMOS.Path.Type.ctl"/>
			<Item Name="TS.Seq.Step.Type.ctl" Type="VI" URL="../Framework/TestStand/Export limits/controls/TS.Seq.Step.Type.ctl"/>
			<Item Name="TS.Seq.Type.ctl" Type="VI" URL="../Framework/TestStand/Export limits/controls/TS.Seq.Type.ctl"/>
			<Item Name="TS.Step.LoadSeqLimits.StepLimits.ctl" Type="VI" URL="../Framework/TestStand/Import limits/ExecutingSeqNoSave/controls/TS.Step.LoadSeqLimits.StepLimits.ctl"/>
